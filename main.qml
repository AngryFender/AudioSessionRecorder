...
/*
        ...
        btn_record.onClicked :{
            if(Page1Form.state =="idle"){
                Page1Form.state = "recording"
                recorder.record();
            ...
            {
                Page1Form.state = "idle"
                recorder.stop()
                console.log("stopped")
                console.log(Page1Form.state)
            }
        }
        ...
        Item {
            ...
            states: [
                ...
                Button {
                    ...
                    onClicked :{
                        if(page_record.state =="idle"){
                            page_record.state = "recording"
                            recorder.record();
                            console.log("recoding")
                        ...
                        {
                            page_record.state = "idle"
                            recorder.stop()
                            console.log("stopped")
                            console.log(page_record.state)
                        }
                    }
                }
